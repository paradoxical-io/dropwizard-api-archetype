...
import com.group.appname.bundles.GuiceBundleProvider;
import com.group.appname.handlers.ParameterHandlerProvider;
...
public class ServiceApplication extends Application<ServiceConfiguration> {
    ...
    private BeanConfig getPublicSwagger(final Environment environment) {
        ...
        swagConfig.setTitle("appname API");
        swagConfig.setDescription("appname API");
        ...
        swagConfig.setContact("admin@appname.com");
